...
MixingManager.addRecipe("flux_zinc_nugget_to_andesite",<constant:create:heat_condition:heated>,[<item:create:andesite_alloy> %100.0],[<item:tfc:powder/flux>,<item:create:zinc_nugget>],[]);
